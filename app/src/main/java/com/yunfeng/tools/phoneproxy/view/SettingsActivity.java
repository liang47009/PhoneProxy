...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    private static Preference.OnPreferenceChangeListener sBindPreferenceSummaryToValueListener = new Preference.OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            if (preference instanceof ListPreference) {
                ...
                stringValue = index >= 0 ? String.valueOf(listPreference.getEntries()[index]) : null;
            } else if (preference instanceof RingtonePreference) {
                // For ringtone preferences, look up the correct display value
                // using RingtoneManager.
                if (TextUtils.isEmpty(stringValue)) {
                    // Empty values correspond to 'silent' (no ringtone).
                    stringValue = preference.getContext().getString(R.string.pref_ringtone_silent);
                } else {
                    ...
                    if (ringtone == null) {
                        ...
                        // name.
                        stringValue = ringtone.getTitle(preference.getContext());
                    }
                }
            } else {
    ...
    private static void bindPreferenceSummaryToValue(Preference preference) {
        ...
        if (preference instanceof SwitchPreference) {
            value = defaultSharedPreferences.getBoolean(preference.getKey(), true);
        } else {
            value = defaultSharedPreferences.getString(preference.getKey(), "");
        }
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // guidelines.
            bindPreferenceSummaryToValue(findPreference("default_porxy_port"));
            bindPreferenceSummaryToValue(findPreference("default_buffer_size"));
            bindPreferenceSummaryToValue(findPreference("example_skin_list"));
            bindPreferenceSummaryToValue(findPreference("change_skin_switch"));
        }

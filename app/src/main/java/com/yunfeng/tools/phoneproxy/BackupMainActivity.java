...
//        view.setEnabled(false);
    ...
    public void clearLog(View view) {
        EditText logEditTextView = (EditText) this.findViewById(R.id.log_editText);
    ...
    private static class MainHandler extends Handler {
        private WeakReference<BackupMainActivity> weakReference;

        private void setWeakReference(BackupMainActivity mainActivity) {
        ...
        public void handleMessage(Message msg) {
            ...
            BackupMainActivity activity = weakReference.get();
            if (null != activity) {
                switch (msg.what) {
